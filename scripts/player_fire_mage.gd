...
func play_animation(movement):
	...
	if dir == "right":
		...
		if movement == 1:
			animation.play("fire_mage_run")
		elif movement == 0:
			animation.play("fire_mage_idle")
...
func attack():
	...
	if Input.is_action_just_released("attack"):
		...
		attack_ip = false
		$AnimatedSprite2D.play("fire_mage_idle")  # Reset to idle animation		
...
func attack1():
	...
	if dir == "right":
		...
		$AnimatedSprite2D.play("fire_mage_attack1")
	elif dir == "left":
...
func attack2():
	...
	if dir == "right":
		$AnimatedSprite2D.flip_h = false
		$AnimatedSprite2D.play("fire_mage_attack2")
	elif dir == "left":
		$AnimatedSprite2D.flip_h = true
		$AnimatedSprite2D.play("fire_mage_attack2")
	elif dir == "down":
...
func attack3():
	...
	if dir == "right":
		$AnimatedSprite2D.flip_h = false
		$AnimatedSprite2D.play("fire_mage_attack3")
	elif dir == "left":
		$AnimatedSprite2D.flip_h = true
		$AnimatedSprite2D.play("fire_mage_attack3")
	elif dir == "down":
...
func attack4():
	...
	if dir == "right":
		$AnimatedSprite2D.flip_h = false
		$AnimatedSprite2D.play("fire_mage_attack4")
	elif dir == "left":
		$AnimatedSprite2D.flip_h = true
		$AnimatedSprite2D.play("fire_mage_attack4")
	elif dir == "down":
